...
public class BorderedRectangleScalable extends SimpleContainer {
	...
	public BorderedRectangleScalable() {
		this(DEFAULT_WIDTH, DEFAULT_HEIGHT, DEFAULT_FILL_COLOR, DEFAULT_BORDER_COLOR);
	}

	public BorderedRectangleScalable(float width, float height) {
		this(width, height, DEFAULT_FILL_COLOR, DEFAULT_BORDER_COLOR);
	}

	public BorderedRectangleScalable(Color fillColor) {
		this(DEFAULT_WIDTH, DEFAULT_HEIGHT, fillColor, DEFAULT_BORDER_COLOR);
	}

	public BorderedRectangleScalable(Color fillColor, Color borderColor) {
		this(DEFAULT_WIDTH, DEFAULT_HEIGHT, fillColor, borderColor);
	}

	public BorderedRectangleScalable(float width, float height, Color fillColor) {
		this(width, height, fillColor, DEFAULT_BORDER_COLOR);
	}

	public BorderedRectangleScalable(float width, float height, Color fillColor, Color borderColor) {
