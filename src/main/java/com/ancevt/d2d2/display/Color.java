...
public class Color {
    ...
    public static final Color DARK_OLIVEGREEN  = new Color(0x556B2F, true);
    public static final Color DARK_ORANGE  = new Color(0xFF8C00, true);
    public static final Color DARK_ORCHID  = new Color(0x9932CC, true);
    public static final Color DARK_RED  = new Color(0x8B0000, true);
    public static final Color DARK_SALMON  = new Color(0xE9967A, true);
    public static final Color DARK_SEAGREEN  = new Color(0x8FBC8F, true);
    public static final Color DARK_SLATEBLUE  = new Color(0x483D8B, true);
    public static final Color DARK_SLATEGRAY  = new Color(0x2F4F4F, true);
    public static final Color DARK_SLATEGREY  = new Color(0x2F4F4F, true);
    public static final Color DARK_TURQUOISE  = new Color(0x00CED1, true);
